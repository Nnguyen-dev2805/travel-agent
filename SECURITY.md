...
Per ADR 0018, ADR 0019, ADR 0021, and ADR 0022, the FastAPI backend enforces mandatory
Bearer token authentication for all `/api/v1` routes. Historical compatibility bypass
