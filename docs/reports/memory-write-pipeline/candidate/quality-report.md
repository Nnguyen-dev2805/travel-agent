...
**Result State:** `PASS`
**Run ID:** `evrun_836c36b6aab9` | **Timestamp:** `2026-09-09T03:57:33.967256+00:00`
...
| --- | --- | --- | --- |
| `candidate_precision` | 1.0000 (7/7) | >=0.95 | YES |
| `candidate_recall` | 1.0000 (7/7) | >=0.90 | YES |
| `key_accuracy` | 1.0000 (7/7) | >=1.00 | YES |
| `value_normalization_accuracy` | 1.0000 (7/7) | >=0.98 | YES |
| `value_normalization_vi_accuracy` | 1.0000 (1/1) | >=0.95 | YES |
| `value_normalization_en_accuracy` | 1.0000 (6/6) | >=0.95 | YES |
| `scope_accuracy` | 1.0000 (7/7) | >=0.98 | YES |
| `scope_hard_accuracy` | 1.0000 (1/1) | >=1.00 | YES |
| `sensitivity_accuracy` | 1.0000 (0/0) | >=1.00 | YES |
| `relationship_accuracy` | 1.0000 (4/4) | >=0.95 | YES |
| `resolver_accuracy` | 1.0000 (4/4) | >=1.00 | YES |
