...
**Result State:** `PASS`
**Run ID:** `evrun_f9363fbde69b` | **Timestamp:** `2026-09-09T03:57:33.967786+00:00`
...
| --- | --- | --- | --- |
| `candidate_precision` | 1.0000 (6/6) | >=0.95 | YES |
| `candidate_recall` | 1.0000 (6/6) | >=0.90 | YES |
| `key_accuracy` | 1.0000 (6/6) | >=1.00 | YES |
| `value_normalization_accuracy` | 1.0000 (6/6) | >=0.98 | YES |
| `value_normalization_vi_accuracy` | 1.0000 (0/0) | >=0.95 | YES |
| `value_normalization_en_accuracy` | 1.0000 (6/6) | >=0.95 | YES |
| `scope_accuracy` | 1.0000 (6/6) | >=0.98 | YES |
