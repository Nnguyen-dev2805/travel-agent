...
Observability and operations is the next runtime design package. `R8` has an
in-review version 0.2 spec, a proposed ADR 0009, and an in-review
implementation plan. It must not begin implementation until the repository owner
accepts ADR 0009 and approves the spec and plan.
...
| `R8` | Observability and Operations | Blocked by gate | `R2`, `D6`, `R7`, [ADR 0009](../adr/0009-privacy-safe-local-observability-boundary.md) | Privacy-safe structured events, request correlation, readiness diagnostics, ops evaluation, and runbook integration | Operators can diagnose degraded memory, retrieval, model, storage, and planner paths without leaking secrets or raw user content | [R8 spec v0.2](../specs/2026-09-05-observability-and-operations-design.md) in review; [ADR 0009](../adr/0009-privacy-safe-local-observability-boundary.md) proposed; [implementation plan v0.3](../plans/2026-09-05-observability-and-operations-implementation.md) in review; implementation waits for owner approval of all three gates |
