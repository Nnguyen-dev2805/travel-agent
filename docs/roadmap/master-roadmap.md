...
| `R9` | Security and Privacy Hardening | Ready for handoff | `D6`, `R3`, `R4`, `R6`, `R8`, [ADR 0010](../adr/0010-local-identity-authorization-and-deletion-boundary.md) | Local authenticated principal boundary, owner authorization, memory deletion semantics, controlled errors, request-size guard, and access boundaries | Privacy-sensitive flows have tests, security evaluation evidence, and refreshed memory hard-gate evidence | [R9 spec v0.2](../specs/2026-09-06-security-and-privacy-hardening-design.md) approved 2026-09-06; [ADR 0010](../adr/0010-local-identity-authorization-and-deletion-boundary.md) accepted 2026-09-06; [implementation plan v0.3](../plans/2026-09-06-security-and-privacy-hardening-implementation.md) approved 2026-09-06; all three gates are satisfied and implementation waits for an assigned worker in an isolated worktree |
