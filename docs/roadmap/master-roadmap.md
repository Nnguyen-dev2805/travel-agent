...
Shadow memory extraction is ready for handoff. `R5` has approved governance
artifacts for a backend-only memory candidate store and shadow evaluation path.
Implementation may start in an isolated worktree under the approved R5 plan.
...
| `R5` | Shadow Memory Extraction | Ready for handoff | `R2`, `R4`, [ADR 0006](../adr/0006-shadow-memory-candidate-store-and-policy-boundary.md) | Memory candidates extracted but not used in answers | Candidate precision, sensitivity, and scope quality are measured | [R5 spec v0.1](../specs/2026-09-04-shadow-memory-extraction-design.md) approved 2026-09-04; [ADR 0006](../adr/0006-shadow-memory-candidate-store-and-policy-boundary.md) accepted 2026-09-04; [implementation plan v0.1](../plans/2026-09-04-shadow-memory-extraction-implementation.md) approved 2026-09-04; implementation is ready for an isolated worker |
| `R6` | Memory Retrieval | Blocked by gate | `R5`, proposed [ADR 0007](../adr/0007-feature-gated-memory-retrieval-and-context-boundary.md) | Feature-gated memory retrieval into bound chat context through orchestration-owned composition | Personalization evidence can be evaluated without privacy, scope, deletion, or grounding regressions | [R6 spec v0.1](../specs/2026-09-04-memory-retrieval-design.md) and [implementation plan v0.1](../plans/2026-09-04-memory-retrieval-implementation.md) are in review; implementation waits for R5 delivery, R5 evaluation evidence, ADR 0007 acceptance, spec approval, and plan approval |
