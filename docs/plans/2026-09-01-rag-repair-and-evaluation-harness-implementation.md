...
- [x] **Step 1: Mark execution start only after plan approval**
...
- [x] **Step 4: Implement immutable runtime value contracts**
...
- [x] **Step 5: Implement Chroma mapping**
...
- [x] **Step 6: Run contract tests green**
...
- [x] **Step 1: Write failing dataset tests**
...
- [x] **Step 2: Run dataset tests red**
...
- [x] **Step 3: Implement strict dataclasses/enums**
...
- [x] **Step 4: Freeze run-config fields**
...
- [x] **Step 5: Implement loader/validator**
...
- [x] **Step 1: Move metric expectations into failing focused tests**
...
- [x] **Step 3: Implement D5 metric functions**
...
- [x] **Step 4: Write failing artifact tests**
...
- [x] **Step 5: Implement deterministic artifact serialization**
...
- [x] **Step 6: Write failing comparison/gate tests**
...
- [x] **Step 7: Implement compatibility and gates**
...
- [x] **Step 8: Implement uncertainty metadata**
...
- [x] **Step 9: Run Task 3 tests green**
...
- [x] **Step 1: Write judge-invalid tests first**
...
- [x] **Step 3: Implement a single-answer judge contract**
...
- [x] **Step 4: Remove synthetic fallback from governed execution**
...
- [x] **Step 5: Write runner role-independence tests**
...
- [x] **Step 6: Implement `CurrentRuntimeAdapter` without changing online RAG**
...
- [x] **Step 8: Implement runner lifecycle**
...
- [x] **Step 10: Add deterministic integration flow**
...
- [x] **Step 11: Run Task 4 tests green**
...
- [x] **Step 1: Inventory corpus identities before writing labels**
...
- [x] **Step 2: Create the frozen manifest**
...
- [x] **Step 3: Curate exactly 25 benchmark examples**
...
- [x] **Step 4: Validate benchmark mechanically**
...
- [x] **Step 5: Repository-owner benchmark review gate**
...
- [x] **Step 6: Freeze baseline run config**
...
- [x] **Step 7: Freeze candidate comparison config before candidate results**
...
- [x] **Step 8: Run baseline retrieval preflight**
...
- [x] **Step 9: Execute canonical retrieval baseline**
...
- [x] **Step 10: Execute full answer baseline when provider prerequisites are available**
...
- [x] **Step 11: Write baseline report**
...
- [x] **Step 12: Review checkpoint — baseline freeze**
...
- [x] **Step 1: Characterize legacy non-empty behavior before edits**
...
- [x] **Step 2: Write failing retriever tests**
...
- [x] **Step 3: Implement `KnowledgeRetriever`**
...
- [x] **Step 4: Write failing context tests**
...
- [x] **Step 5: Implement `ContextAssembler`**
...
- [x] **Step 6: Write failing generator tests**
...
- [x] **Step 7: Implement `LLMGenerator`**
...
- [x] **Step 8: Rewrite `RAGService` as a thin facade**
...
- [x] **Step 9: Preserve chat API compatibility in integration tests**
...
- [x] **Step 10: Run R1 targeted tests**
...
- [x] **Step 11: Wire `StructuredRuntimeAdapter`**
...
- [x] **Step 12: Review checkpoint — candidate source freeze**
