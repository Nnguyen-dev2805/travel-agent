...
| Superseded by | [Authenticated Chat-Only PostgreSQL Clean Break](./2026-09-10-authenticated-chat-postgresql-clean-break-design.md) v0.1 retired the legacy Workspace/SQLite shadow surface; later Memory write-pipeline designs govern retained Memory capability |
