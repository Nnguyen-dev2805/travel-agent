...
| Superseded ADR | None |
| Superseded by | [ADR 0012](./0012-versioned-semantic-memory-in-postgresql.md) for active target storage. [ADR 0004](./0004-shared-local-application-store-and-per-module-schema-registry.md) remains historical evidence for the SQLite compatibility period |
