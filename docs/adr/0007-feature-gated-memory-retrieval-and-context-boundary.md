...
| Superseded ADR | None |
| Superseded by | [ADR 0013](./0013-model-assisted-extraction-and-deterministic-resolution.md) supersedes correction/promotion rule 9 for the V2 write path; the retrieval/context seam and legacy feature gate remain Accepted until a later read-pipeline ADR replaces them |
