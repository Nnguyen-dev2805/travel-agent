...
| Superseded ADR | None |
| Superseded by | [ADR 0039](./0039-memory-read-use-authority-and-retrieval-projections.md) supersedes the retrieval/context seam; [ADR 0013](./0013-model-assisted-extraction-and-deterministic-resolution.md) had already superseded correction/promotion rule 9 for the V2 write path |
